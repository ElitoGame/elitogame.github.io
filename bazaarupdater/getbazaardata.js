...
export const name = 'bazaarupdate';
export const description = 'Saves the current bazaar data';
export async function execute() {
	...
	for (i in products) {
		...
		if (products[i].sell_summary["0"] == null || products[i].buy_summary["0"] == null)
			continue;
